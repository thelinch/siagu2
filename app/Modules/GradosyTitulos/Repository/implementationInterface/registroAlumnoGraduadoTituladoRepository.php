...
class registroAlumnoGraduadoTituladoRepository implements registroAlumnoGraduadoTituladoRepositoryInterface
{
    ...
    public function create(Request $data)
    {
       ...
       return $this->model->with(["AlumnoGraduadoTitulado","Rector.Docente.Persona","TrabajadorAreas.administrativo.Persona","TrabajadorAreas.cargo","TipoDiploma"])->where("id", $registroAlumnoGraduadoTituladoCreado->id)->get()->first();
